                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="video-form" v-if="uploading && !failed">
                            ...
                            <div class="alert alert-info" v-if="!uploadingComplete">Your video will be available at 
                             ...
                             <div class="alert alert-success" v-if="uploadingComplete">Uploading Complete! Video is now processing! <a href="/videos">Go to your videos.</a></div>
